...
FILE_KEYWORDS = {
    ...
    "privacy_policy": ["隐私政策", "隐私权政策", "个人信息保护政策", "个人信息处理规则",
                       "个人信息保护规则", "隐私声明", "privacy", "policy", "隐私"],
    "user_agreement": ["用户协议", "服务协议", "user_agreement", "terms", "服务条款",
                       "用户服务协议"],
    "sdk_list": ["sdk", "SDK", "第三方", "sdk清单", "sdk列表", "第三方清单", "第三方sdk"],
    "permission_list": ["权限", "permission", "权限清单", "权限列表", "系统权限"],
    ...
    "elderly_adaptation": ["适老", "无障碍", "elderly", "关怀", "长辈", "老年"],
    "child_protection": ["儿童", "未成年", "child", "minor", "青少年"],
    "data_export": ["出境", "跨境", "export", "cross_border", "数据跨境", "数据出境"],
    "pia_report": ["pia", "影响评估", "impact_assessment", "个人信息保护影响"],
    "security_assessment": ["等保", "安全评估", "security", "assessment", "网络安全等级"],
    "auto_renewal": ["续费", "会员", "订阅", "renewal", "subscription", "自动扣费"],
}
...
def _force_utf8_output():
    ...
    报告中含 emoji 与中文，而 Windows 在输出被重定向/管道接收时会退回
